...
<h2>Overview</h2>
<div class="section">
    <p>This mod aims to reduce the amount and influence of magic that was barfed into the world.</p>
    <p>The mod removes "+1," "+2," etc. from item names, and standardizes the enchantment levels of weapons for purposes of which enemies they can hit:</p>
    <ul>
    ...
    <p><b>Compatibility:</b> this mod covers the same ground as the SCS component "Make +1 Weapons Into Fine Weapons." This component also has other effects, of course. You should not install that component of SCS if you want to use this component.</p>
</div>
</body>
</html>
